...
const routes: Routes = [
  {
    path: '',
    redirectTo: 'selector-login', // <--- Cambio aquí: Redirige a la pantalla de login al abrir la app
    pathMatch: 'full'
  },
  {
    path: 'selector-login',
  ...
  {
    path: 'pedidos-unitarios',
    loadChildren: () => import('./pages/pedidos-unitarios/pedidos-unitarios.module').then( m => m.PedidosUnitariosPageModule)
  }
];
